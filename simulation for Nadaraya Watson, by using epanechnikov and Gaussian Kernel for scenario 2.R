...
# SIMULATION STUDY
# Scenario 2: Increasing theta(z) = 1.5 + 2z
...
output_folder <-
  "Scenario_2_Increasing_Gaussian_NW_Simulation"
...
cat("\n")
cat("\n")
cat("SCENARIO 2: INCREASING THETA(z) = 1.5 + 2z\n")
...
output_folder <-
  "Scenario_2_Increasing_Epanechnikov_NW_Simulation"
