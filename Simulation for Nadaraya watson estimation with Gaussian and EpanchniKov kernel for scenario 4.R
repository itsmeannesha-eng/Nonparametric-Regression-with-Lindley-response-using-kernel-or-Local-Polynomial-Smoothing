...
output_folder <-
  "Scenario_4_Nonlinear_Gaussian_NW_Simulation"
...
cat("\n")
cat("\n")
cat("SCENARIO 4: NONLINEAR THETA(z) = 1.5 + 2(z - 0.5)^2\n")
...
# 14. CREATE RESULT DIRECTORY
output_folder <-
  "Scenario_4_Nonlinear_Epanechnikov_NW_Simulation"
