# SIMULATION STUDY
# Scenario 3: Decreasing theta(z) = 3.5 - 2z
...
output_folder <-
  "Scenario_3_Decreasing_Gaussian_NW_Simulation"
...
cat("\n")
cat("\n")
cat("SCENARIO 3: DECREASING THETA(z) = 3.5 - 2z\n")
...
# 14. CREATE RESULT DIRECTORY
output_folder <-
  "Scenario_3_Decreasing_Epanechnikov_NW_Simulation"
