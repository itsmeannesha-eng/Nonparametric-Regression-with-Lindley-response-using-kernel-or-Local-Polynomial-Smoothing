...
output_folder <-
  "Scenario_5_Sinusoidal_Gaussian_NW_Simulation"
...
cat(
  "1. pointwise_results.csv\n"
)

cat(
  "2. integrated_results.csv\n"
)

cat(
  "3. bandwidth_results.csv\n"
)

cat(
  "4. average_bandwidth.csv\n"
)
...
# 14. CREATE RESULT DIRECTORY
output_folder <-
  "Scenario_5_Sinusoidal_Epanechnikov_NW_Simulation"
